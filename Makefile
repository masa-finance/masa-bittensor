...
run-miner-1:
	python neurons/miner.py --netuid $(NETUID) --subtensor.$(SUBTENSOR_ENVIRONMENT) --wallet.name miner --wallet.hotkey default --axon.port 8091 --neuron.debug --logging.debug --logging.logging_dir ~/.bittensor/wallets --blacklist.force_validator_permit --twitter.max_tweets_per_request 50

run-miner-2:
	python neurons/miner.py --netuid $(NETUID) --subtensor.$(SUBTENSOR_ENVIRONMENT) --wallet.name miner --wallet.hotkey second --axon.port 8092 --neuron.debug --logging.debug --logging.logging_dir ~/.bittensor/wallets --blacklist.force_validator_permit --twitter.max_tweets_per_request 50

run-miner-3:
	python neurons/miner.py --netuid $(NETUID) --subtensor.$(SUBTENSOR_ENVIRONMENT) --wallet.name miner --wallet.hotkey third --axon.port 8093 --neuron.debug --logging.debug --logging.logging_dir ~/.bittensor/wallets --blacklist.force_validator_permit --twitter.max_tweets_per_request 50
